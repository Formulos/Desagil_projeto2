...
public class MainView extends JPanel implements ActionListener {
	...
	private JComboBox<Calculator> comboBox;

	private CalculatorView calculatorView;


	public MainView(List<Calculator> model) {
	...
	public void actionPerformed(ActionEvent event) {
		...
		Calculator calculator = comboBox.getItemAt(index);
		addCalculatorView(calculator);
